				...
				{#each product.images as image, index}
					{#if index == tab}
						<img
							...
							class={'w-12 h-12 w-full flex-shrink-0 mb-4 object-cover rounded-lg border-2 border-orange-400'}
							src={image.url}
							alt={image.url}
						/>
					{:else}
						<img
							...
							class={'w-12 h-12  w-full flex-shrink-0 mb-4 object-cover rounded-lg'}
							src={image.url}
							alt={image.url}
						/>
					{/if}

...
{#if messages}
	<div class="my-6 bg-white rounded-3xl border border-gray-600 text-black md:mx-40 ">
		<p
		...
		>
			...
			<button
				type="submit"
				class="absolute inset-y-0 right-4 w-10 max-w-min items-center justify-center"
			>
